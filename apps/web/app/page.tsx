  ...
  return (
    <section className="space-y-6">
      <div className="space-y-3">
        <p className="text-sm uppercase tracking-[0.2em] text-accent">Epic 00 · M4</p>
        <h1 className="font-display text-4xl leading-tight md:text-5xl">UI shell is online</h1>
